...
Fiscal code or VAT no. of the debtor who has the debt position.
{% endtab %}
...
{% tab title="Note" %}
It is possible to omit the value only if it is not known, for example a foreign citizen who does not have an Italian fiscal code.
{% endtab %}
{% endtabs %}
...
{% tabs %}
{% tab title="Definizione" %}
First and last name of the debtor who has the debt position
{% endtab %}
...
{% tabs %}
{% tab title="Definizione" %}
Address of the debtor who has the debt position
{% endtab %}
