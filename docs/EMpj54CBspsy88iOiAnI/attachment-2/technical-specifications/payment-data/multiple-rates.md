---
description: >-
  Use this portion to indicate the details regarding making a payment in
...
{% hint style="info" %}
\*\*New:\*\* it is now possible to insert the installments also on the first page!
{% endhint %}

{% hint style="warning" %}
If the creditor has a postal current account for collections, also the \[postal-payment-slip.md]\(postal-payment-slip.md "mention") must be included immediately after this portion.
{% endhint %}
...
{% hint style="info" %}
If necessary for space reasons, you can omit the item \*\*Recipient\*\*.
{% endhint %}
