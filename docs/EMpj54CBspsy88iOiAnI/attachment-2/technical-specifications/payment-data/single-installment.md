---
description: >-
  Use this portion to indicate the details regarding making a single payment, if
  applicable.
---
...
{% tab title="Note" %}
The list of the CBILL codes is available on the \[CBILL website]\(https://www.cbill.it/chi-puoi-pagare).
{% endtab %}
{% endtabs %}
