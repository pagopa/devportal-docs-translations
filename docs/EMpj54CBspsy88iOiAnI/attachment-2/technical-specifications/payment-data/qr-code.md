---
description: This page defines the structure of the string to code in the QR code
---
...
{% hint style="info" %}
You can find numerous services online for generating and testing QR codes.
{% endhint %}
