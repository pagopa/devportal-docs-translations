...
{% tabs %}
{% tab title="Definizione" %}
References to the creditor’s contact channels for citizens, for example a website, call center or dedicated email address.
{% endtab %}
...
{% tab title="Note" %}
* In the case of a single row, alignment must be with the upper edge.
* If multiple elements need to be entered, you can use an [interpunct](https://it.wikipedia.org/wiki/Punto_mediano) ""·"" as a separator
{% endtab %}
{% endtabs %}
