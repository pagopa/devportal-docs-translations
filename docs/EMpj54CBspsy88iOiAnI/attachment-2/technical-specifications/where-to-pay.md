---
description: >-
  This section presents the various channels where it is possible to pay a
  pagoPA notice, online and in person.
---

# Where to pay

{% hint style="info" %}
\*\*New:\*\* pay attention to the new texts in this version, they are now easier to implement and simpler and more inclusive for users.
{% endhint %}
...
{% hint style="warning" %}
Do you need to enter the website of the institution? Do not change this text, but use the placeholder \[#ente-info]\(information-about-the-creditor.md#ente-info "mention")
{% endhint %}
...
A fixed text that lists the website (or app) of the creditor among the available channels, if it permits to pay the notice,
{% endtab %}
...
* ""on the website or app of""[""Institute.Name""](information-about-the-creditor.md#ente-nome)"","”
{% endtab %}

{% tab title="Note" %}
Variable to use in the explanation text of the digital channels, as described in \[#sezione-canali-digitali]\(where-to-pay.md#sezione-canali-digitali "mention").
{% endtab %}
{% endtabs %}
...
{% tabs %}
{% tab title="Se non si può pagare presso l" %}
```markdown
**PAY IN PERSON**
...
{% tab title="Se si può pagare presso l" %}
```markdown
**PAY IN PERSON**
...
{% tab title="Note" %}
Do not enter references to external resources or websites. For this type of information, use the placeholder \[#ente-info]\(information-about-the-creditor.md#ente-info "mention").
{% endtab %}
{% endtabs %}
