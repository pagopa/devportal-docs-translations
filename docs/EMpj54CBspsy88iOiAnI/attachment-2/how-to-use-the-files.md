...
{% hint style="info" %}
A free account is necessary to consult the read-only specifications and access the Inspect panel.

[**Create a free account on Figma.com -->**](https://www.figma.com)
{% endhint %}
