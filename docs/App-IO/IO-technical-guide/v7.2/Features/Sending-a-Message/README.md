...
All IO APIs can return error responses, defined in the specifications of each API._._ **It is necessary to implement client-side mechanisms for the correct handling of this type of response.**
