...
See the [Reserved Area Operational Manual](https://docs.pagopa.it/area-riservata/area-riservata/come-funziona/gruppi) for more details on Groups.
...
## **Who can manage groups?** <a href="#who-can-manage-groups" id="who-can-manage-groups"></a>
...
## Procedure to configure a group on IO: <a href="#steps-to-configure-a-group-on-io" id="steps-to-configure-a-group-on-io"></a>
