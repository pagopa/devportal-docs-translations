...
3. Click on the **"Submit for review"** button at the top;&#x20;
...
1. Retrieve the relevant [API specifications](../../APIs-and-Specifications/Service-APIs/Manage-Service-Create.md) and read the advice carefully
...
To retrieve the keys for the created service, you can refer to [Manage Service: Get keys. ](../../APIs-and-Specifications/Service-APIs/Manage-Service-Get-Keys.md)
