...
🔴 If the service has been **rejected**, you can find the reason for the rejection. Correct the service as indicated, and then resubmit it for evaluation.
...
🟢  If the service is in the **`APPROVED`** state, it is ready to be activated. If you have chosen automatic activation, the service will already be **`PUBLISHED`** (i. e., **activated**)\
