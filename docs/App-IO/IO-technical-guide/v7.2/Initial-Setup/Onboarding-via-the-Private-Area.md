...
2. one or more **Administrators**, i.e., the people who will have all permissions on that product.

Once this data is entered, the Reserved Area **will send a contract** to the requesting organization's PEC. This must be **digitally signed** by the legal representative and **uploaded** to the Reserved Area via the _magic link_ provided in the certified email.
