...
{% hint style="danger" %}
**Warning**: the following API will be deprecated soon, therefore its use is discouraged. Use [get-a-user-profile-using-post.md](get-a-user-profile-using-post.md "mention")
{% endhint %}
...
2. in the response body the field **`sender_allowed=true`**
