...
The purpose of the _subscription feed_ is to provide central entities with a tool to minimise calls to the IO infrastructure through a filter built by the entity itself.&#x20;
