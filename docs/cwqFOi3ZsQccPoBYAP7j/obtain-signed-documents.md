...
{% hint style="warning" %}
The IO app will keep the signed documents for only 90 days, to allow the user to view, download and/or share the files.

The legal retention period - and the possible return to the user upon request - is the responsibility of the institution. The QTSP (Qualified Trusted Service Provider) is required to keep the one shot signature certificates for 20 years.
{% endhint %}
