...
The title of the dossier **may NOT be generic** or contain information that is already present (such as the name of the institution or the text “signature request").
{% endhint %}
...
{% hint style="warning" %}
**Take note of the `dossier_id`**: you will need it in a following phase.
{% endhint %}
