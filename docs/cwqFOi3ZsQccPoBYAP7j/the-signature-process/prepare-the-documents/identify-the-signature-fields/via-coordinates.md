...
{% hint style="warning" %}
Make sure that the signature field does not go beyond the entire page. When uploading the PDF, the software checks in any case that the coordinates are correct.
{% endhint %}
