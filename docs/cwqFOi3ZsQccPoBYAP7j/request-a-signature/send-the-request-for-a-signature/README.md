...
{% hint style="danger" %}
Once the signature request has been published, it will no longer be possible to change it or change the attached documents. It will only be possible to \*\*delete it\*\*.
{% endhint %}
...
[via-message-on-io.md](via-message-on-io.md)
{% endcontent-ref %}
