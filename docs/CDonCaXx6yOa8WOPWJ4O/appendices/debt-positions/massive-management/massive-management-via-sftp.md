...
{% hint style="info" %}
It will soon be possible to obtain credentials autonomously by accessing the BackOffice-pagoPA portal
{% endhint %}
...
{% hint style="info" %}
As indicated in the \_Input trace specifications\_ section, the constraint of univocality of the file name must be respected.
{% endhint %}
