---
description: >-
  On IO, you can add debit, credit, and prepaid cards (enabled for e-commerce transactions) to the Wallet and pay pagoPA notices.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/EnBg5c1okkV2J4KL0TcG/esperienza-per-il-cittadino/app-io/carte
---
...
Payment of a pagoPA notice with a card via the IO app.
{% endembed %}
