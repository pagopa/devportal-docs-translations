...
Use this when activation of an Agreement requires manual approval by the producer. The producer can choose manual approval when defining a version of the e-service. For more information, see the [dedicated section](../../../technical-guide/e-services/#informazioni-di-versione).
...
{% hint style="warning" %}
This endpoint is not yet available, but can be executed manually via the back office. For more information, see the [dedicated section](../../../technical-guide/attributi/).
{% endhint %}
