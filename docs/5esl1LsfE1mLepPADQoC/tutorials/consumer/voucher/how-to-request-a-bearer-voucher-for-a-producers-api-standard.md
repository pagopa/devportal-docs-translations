...
More information on this implementation can be found in the [dedicated section](../../../technical-guide/utilizzare-i-voucher/types-of-voucher-requests.md#bearer-token-spendibile-presso-le-api-di-un-erogatore-base).
...
For recommended checks for producers, see the [dedicated section](../../../technical-guide/utilizzare-i-voucher/checks-on-a-bearer-voucher-by-a-producer.md).
