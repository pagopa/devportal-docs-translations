...
For more information, see the [dedicated section](../../../technical-guide/utilizzare-i-voucher/ensuring-response-integrity.md).
...
Once the payload created by the producer in the [previous tutorial](../../producer/voucher/how-to-sign-a-response-for-a-subscriber.md) has been deserialized, the consumer will find the JSON response that the producer sent, structured as follows:
...
The key corresponding to the `kid` is available on the [APIs](../../../technical-guide/api-esposte-da-pdnd-interoperabilita/) exposed by PDND.
