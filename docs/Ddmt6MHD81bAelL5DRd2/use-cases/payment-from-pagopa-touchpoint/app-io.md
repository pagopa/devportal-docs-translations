...
* The user that starts the payment using the IO app <img src="../../.gitbook/assets/image (4).png" alt="" data-size="line"> must scan the QR code located on the payment notice;
