---
description: >-
  This section guides you through the configuration of the “Groups” function in
  the Reserved area, which allows you to define the visibility      of services
  with respect to one or more users (operators
---
...
{% hint style="danger" %}
A service can be associated with only one group.
{% endhint %}
