...
As a further measure to protect privacy, the [#require\_secure\_channels ](../../apis-and-specifications/service-api/submit-a-message-passing-the-user-fiscal-code-as-path-parameter.md)flag allows you to **mark a message as containing sensitive information**, with the following effects:
