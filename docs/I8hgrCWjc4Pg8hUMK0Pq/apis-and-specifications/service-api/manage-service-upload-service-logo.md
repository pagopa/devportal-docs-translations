...
{% hint style="info" %}
If the logo is uploaded just after the service was created, it is possible that the API returns error \`401\`. If this happens, wait a few seconds and upload the logo again.
{% endhint %}
