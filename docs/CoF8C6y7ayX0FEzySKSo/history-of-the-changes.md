...
* Update of the section [**The IO functions available to institutions**](the-io-app/the-functions-of-io-available-to-institutions/) on the page Informing citizens or Obtaining a payment;
* The page [**Access via Single Sign-on**](the-io-app/the-functions-of-io-available-to-institutions/access-via-single-sign-on.md) was created in the section [**The IO functions available to institutions**](the-io-app/the-functions-of-io-available-to-institutions/),;
