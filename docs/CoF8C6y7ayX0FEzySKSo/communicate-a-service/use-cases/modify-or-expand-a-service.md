...
2.  **post on the digital channels** on institutional and social media channels to launch the news.
    ...
    <div data-gb-custom-block data-tag="hint" data-style="warning" class="hint hint-warning"><p><strong>Does the change concern a service that has an impact on the entire national territory?</strong></p></div>
