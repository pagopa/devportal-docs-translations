...
If there are errors in a message, we recommend referring to section [what-do-to-in-case-of-errors-when-sending-an-email](../../what-a-service-can-do-with-io/what-do-to-in-case-of-errors-when-sending-an-email/ "mention"), which includes some message templates to customize and use depending on the type of error.
