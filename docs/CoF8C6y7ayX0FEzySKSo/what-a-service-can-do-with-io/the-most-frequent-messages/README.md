...
{% hint style="info" %}
For a more complete guide on the use of the markdown, [see the IO technical guide ](https://app.gitbook.com/s/I8hgrCWjc4Pg8hUMK0Pq/useful-resources/guide-to-markdown).
{% endhint %}
