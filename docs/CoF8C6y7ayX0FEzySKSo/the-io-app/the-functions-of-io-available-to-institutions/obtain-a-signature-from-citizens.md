...
The institution requests the user to sign a document by sending a message on the IO app. The institution can also insert a signature request on their website with a dedicated button that makes it possible to open IO and complete the operation.
{% endstep %}

{% step %}
#### The documents are visible on IO

The user accesses the IO app to view the documents to be signed, read the clauses and the conditions of the service provider of the qualified signature.
{% endstep %}
