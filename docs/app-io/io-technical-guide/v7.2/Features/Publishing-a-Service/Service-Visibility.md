...
Every service for which a [review has been requested](Service-Review.md) via the Developer Portal is automatically activated.

#### Via the Reserved Area

Every service for which a [review has been requested](Service-Review.md) via the Reserved Area is automatically activated.&#x20;
...
- You can use the [specific `service release` API](../../APIs-and-Specifications/Service-APIs/Manage-Service-Release.md) to publish an approved service.
...
6. In your list of services, identify the service you want to check and click on its box.
...
{% hint style="info" %}
You can only use the specific key named [`manage`](Manage-Key/Manage-Key.md)
{% endhint %}
...
1. Make the API call to [hide the service](../../APIs-and-Specifications/Service-APIs/Manage-Service-Unpublish.md)
