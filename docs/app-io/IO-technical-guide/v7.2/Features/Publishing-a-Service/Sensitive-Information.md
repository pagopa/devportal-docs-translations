...
The data in question are those indicated in Articles. Articles 9 and 10 of the GDPR, namely:&#x20;
...
{% hint style="info" %}
The same feature is also available at the individual message level: for more information, refer to [#require\_secure\_channels](../../APIs-and-Specifications/Message-APIs/Submit-a-Message-Passing-the-User-Fiscal-Code-in-the-Request-Body.md#require_secure_channels "mention")
{% endhint %}
