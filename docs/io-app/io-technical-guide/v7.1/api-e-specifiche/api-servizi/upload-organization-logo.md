...
where **`<ORGANIZATION_FISCAL_CODE>`** is the [`organization_fiscal_code`](../../funzionalita/pubblicare-un-servizio/dati-obbligatori/attributi.md#organization_fiscal_code) **without any leading zeros** from the organization's fiscal code.
