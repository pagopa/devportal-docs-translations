...
The data related to [#content](Submit-a-message-passing-the-user-fiscal-code-in-the-request-body.md#content "mention") are the same as those sent when the message was created.
