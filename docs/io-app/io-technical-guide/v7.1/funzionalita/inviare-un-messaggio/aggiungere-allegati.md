...
{% hint style="info" %}
This feature is reserved for organizations that have subscribed to the [Premium program](../../abilitazioni/funzionalita-premium.md).
{% endhint %}
...
To allow IO to know about your systems dedicated to attachments, **you must define at least one** [**Remote Configuration**](../../setup-iniziale/configurazione-remota.md), which you will specify later when [sending each message](inviare-un-messaggio-a-contenuto-remoto.md).
...
Specify the value `true` in the [#has\_attachments](../../api-e-specifiche/api-messaggi/submit-a-message-passing-the-user-fiscal_code-in-the-request-body.md#has_attachments "mention") field present in the [#third\_party\_data](../../api-e-specifiche/api-messaggi/submit-a-message-passing-the-user-fiscal_code-in-the-request-body.md#third_party_data "mention") block.
...
Specify the value `ADVANCED` in the [#feature\_level\_type](../../api-e-specifiche/api-messaggi/submit-a-message-passing-the-user-fiscal_code-in-the-request-body.md#feature_level_type "mention") field in the request.
