...
If you intend to [send a remote content message](inviare-un-messaggio-a-contenuto-remoto.md), follow the [relevant instructions](inviare-un-messaggio-a-contenuto-remoto.md#come-funziona-linvio-di-un-messaggio-a-contenuto-remoto) on how to integrate.

You can also add [PDF/A attachments](aggiungere-allegati.md). For more information, read the [relevant instructions](aggiungere-allegati.md).
...
[Learn how to send a traditional message ->](../../api-e-specifiche/api-messaggi/submit-a-message-passing-the-user-fiscal_code-in-the-request-body.md)
...
[Learn how to send a remote content message ->](inviare-un-messaggio-a-contenuto-remoto.md)
