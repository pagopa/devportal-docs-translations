...
{% hint style="info" %}
The code is alphanumerical and may not exceed 20 characters.
{% endhint %}
...
{% hint style="warning" %}
Different opportunities can be associated with different static codes for greater security.
{% endhint %}
