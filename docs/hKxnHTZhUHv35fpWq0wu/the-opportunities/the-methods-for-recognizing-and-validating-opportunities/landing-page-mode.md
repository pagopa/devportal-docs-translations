...
{% hint style="warning" %}
The page of the opportunities must be coherent with the description provided in the IO app and may not contain a set of similar initiatives that could make navigation difficult for beneficiaries and lead to complaints.
{% endhint %}
...
{% hint style="info" %}
The check of the header names must NOT be performed in a \_case-sensitive\_ manner
{% endhint %}
