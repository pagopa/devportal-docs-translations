...
Specify the value `ADVANCED` in the field [#feature\_level\_type](../../apis-and-specifications/api-messages/submit-a-message-passing-the-user-tax-code-in-the-request-body.md#feature\_level\_type "mention") present in the request.
